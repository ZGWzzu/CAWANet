...
from dataset.MT_dataset import VOCSegmentation
...
def evaluate(model, data_loader, device, num_classes):
    ...
    header = 'Test:'
    with torch.no_grad():
        for image, target, _, size,_ in metric_logger.log_every(data_loader, 100, header):
...
def main():
    ...
    # load image
    evaluate(model, val_loader, device, num_classes=6)
